...
/**
 * NTP goose.Timestamp according to RFC-2030.
 * 
...
//	public static final double UNIX_TIME_CORRECTION = 2208988800.0;
	public static final double UNIX_TIME_CORRECTION = 0.0;
...
// * @see java.util.Date
// */
//public class goose.Timestamp implements java.io.Serializable, Comparable<goose.Timestamp>
//{
...
//     */
//    public goose.Timestamp(long ntpTime)
//    {
...
//     */
//    public goose.Timestamp(String s) throws NumberFormatException
//    {
...
//     *
//     * @param d - the Date to be represented by the goose.Timestamp object.
//     */
//    public goose.Timestamp(Date d)
//    {
//        ntpTime = (d == null) ? 0 : toNtpTime(d.getTime());
//    }
//
//    /***
//     * Returns the value of this goose.Timestamp as a long value.
//     *
...
//     *
//     * @return NTP goose.Timestamp in Java time
//     */
//    public long getTime()
//    {
...
//     *
//     * @return NTP goose.Timestamp in Java Date
//     */
//    public Date getDate()
//    {
...
//     */
//    public static goose.Timestamp getNtpTime(long date)
//    {
//        return new goose.Timestamp(toNtpTime(date));
//    }
//
//    /***
...
//     */
//    public static goose.Timestamp getCurrentTime()
//    {
...
//     *
//     * @param s - hexstring.
//     * @return the goose.Timestamp represented by the argument in hexidecimal.
//     * @throws NumberFormatException - if the string does not contain a parsable timestamp.
//     */
//    public static goose.Timestamp parseNtpString(String s)
//            throws NumberFormatException
//    {
//        return new goose.Timestamp(decodeNtpHexString(s));
//    }
//
//    /***
...
//
//    /***
//     * Computes a hashcode for this goose.Timestamp. The result is the exclusive
...
//    {
//        if (obj instanceof goose.Timestamp) {
//            return ntpTime == ((goose.Timestamp) obj).ntpValue();
//        }
//        return false;
//    }
//
...
//     */
////    @Override
//    public int compareTo(goose.Timestamp anotherTimeStamp)
//    {
...
//	public static final double NTP_SCALE = 4294967296.0;
//    
//    public goose.Timestamp(byte[] data) {
//		if (data == null || data.length != 8) {
//			throw new IllegalArgumentException(
//					"Byte array must be exactly 64 bits");
//		}
...
//			d = 256.0 * d + byteToUnsignedInt(data[i]);
//		}
//		this.ntpTime = 3232323;
//		this.ntpTimestamp = d / NTP_SCALE;
//	}
//    
//    
//	
